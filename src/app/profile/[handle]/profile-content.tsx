            ...
            <div className="p-6 space-y-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-end sm:justify-between">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="pt-2">
                           <CardTitle className="text-2xl font-bold font-headline flex items-center gap-2">{profileData.name} {getStatusEmoji(profileData.graduationYear, profileData.graduationMonth)}</CardTitle>
